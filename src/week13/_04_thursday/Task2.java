...
// Find the count of given character in the string  -->  String str = "helloxxhello";
// ch = 'x' ---> count = 2  --- then verify it is unique in the string or not?

public class Task2 {

    public static void main(String[] args) {

        String str = "hellohello";  // Positive Scenarios + Negative Scenarios
        ...
        // How can you test a vacuum machine?
